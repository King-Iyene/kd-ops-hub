    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl font-bold truncate" title={client.name}>{client.name}</h1>
              ...
              {client.website && (
                <p className="text-sm flex items-center gap-2 text-muted-foreground">
                  ...
                  {safeHref(client.website) ? (
                    <a href={safeHref(client.website)!} target="_blank" rel="noopener noreferrer" className="hover:underline truncate transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded">
                      {client.website}
                    </a>
                  ) : (
