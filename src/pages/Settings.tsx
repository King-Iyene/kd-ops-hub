        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            ...
            <CardContent className="text-xs space-y-2 leading-relaxed">
              ...
              <p><strong>Phase 4 — Employee Loans.</strong> The Loans page (Finance → Loans) manages staff loans from disbursement to full repayment. Monthly installments are calculated automatically (supports both interest-free and interest-bearing loans using the standard annuity formula). A database trigger marks loans as "Fully Paid" automatically when total repayments reach the loan amount. Each repayment can be tagged as payroll deduction, bank transfer, or cash. Outstanding balance and repayment progress are shown per loan. Loans can be written off when recovery is unlikely.</p>
          ...
          <RefSection icon={Sparkles} title="What we polished recently (in plain English)">
            <RefTable
              ...
              rows={[
                ...
                { a: 'Employee Loans',                        b: 'Create staff loans with auto-calculated monthly installments (interest-free or interest-bearing). A DB trigger marks loans as fully paid automatically. Each repayment is tagged payroll deduction, bank transfer, or cash. Outstanding balance and repayment progress shown per loan.' },
