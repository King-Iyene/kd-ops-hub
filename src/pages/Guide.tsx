// Company Guide / System Reference — read-only reference of every cap,
// approval rule, retention policy, security setting, and operational
// threshold the platform enforces, organised by module. Visible to every
// authenticated role (not just admins) since everyone benefits from
// knowing how the system behaves, not just the people who configure it.
//
// This used to live inside Settings -> System Reference, gated to
// super_admin/admin, but Settings itself is a super_admin-only route so
// nobody else could ever see it. Moved to its own route so it's reachable
// by every role.
...
export default function Guide() {
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <PageHeader title="Company Guide" description="Every cap, approval rule, retention policy, and security setting KDOps enforces — in one place." />
      <GuideBody />
    </div>
  );
}
