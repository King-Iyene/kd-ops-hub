...
const TEMPLATES = [
  { icon: Kanban, name: 'Project Tracker', desc: 'Track tasks, assignees, and deadlines', color: '#3366FF' },
  { icon: Users, name: 'CRM', desc: 'Manage contacts, deals, and pipeline', color: '#0D9488' },
  { icon: BarChart3, name: 'Sales Pipeline', desc: 'Track leads through your sales funnel', color: '#8B5CF6' },
  { icon: FileSpreadsheet, name: 'Content Calendar', desc: 'Plan and schedule content across channels', color: '#F59E0B' },
  { icon: CheckSquare, name: 'Bug Tracker', desc: 'Log, prioritize, and resolve issues', color: '#EF4444' },
  { icon: Database, name: 'Inventory', desc: 'Manage products, stock, and suppliers', color: '#10B981' },
];
