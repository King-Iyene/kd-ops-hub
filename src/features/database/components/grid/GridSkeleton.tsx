    ...
    <div className="flex flex-col h-full animate-in fade-in duration-200">
      ...
      >
        ...
        {Array.from({ length: SKELETON_COLS }).map((_, i) => (
          <div
            key={i}
            className="shrink-0 flex items-center px-3 border-r border-[#E7E7E9] dark:border-[hsl(200,25%,18%)]"
            style={{ width: 180 }}
          >
            <div className="h-3 rounded bg-[#E7E7E9] dark:bg-[hsl(200,25%,18%)] skeleton-pulse" style={{ width: 60 + Math.random() * 40 }} />
          </div>
        ))}
      </div>
      ...
      {Array.from({ length: SKELETON_ROWS }).map((_, rowIdx) => (
        ...
        >
          ...
          {Array.from({ length: SKELETON_COLS }).map((_, colIdx) => (
            ...
            >
              <div
                className="h-3 rounded bg-[#E7E7E9] dark:bg-[hsl(200,25%,18%)] skeleton-pulse"
                style={{
