 ...
 */
// Note: payslip previews render in-page via <PayslipPreviewDialog> (an
// iframe in a dialog), not window.open() — a real user hit a browser/site
// pop-up permission that silently blocked a new tab outright. An in-page
// dialog has no such dependency.
