      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="rounded-lg border p-4 text-sm space-y-2">
          ...
          <div className="relative">
            ...
            />
            <span
              className={`absolute right-3 top-1/2 -translate-y-1/2 text-3xs tabular-nums pointer-events-none ${
                narrationOverLimit
        ...
        <div className="rounded-lg border p-4 text-sm space-y-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              ...
              <Badge key={String(f)} variant="secondary" className="text-2xs font-normal">
                {f}
              </Badge>
            ))}
          </div>
                ...
                <div key={idx} className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    {(it.bank_name || it.account_number) && (
                      <span className="block text-3xs text-muted-foreground font-mono tracking-tight truncate">
