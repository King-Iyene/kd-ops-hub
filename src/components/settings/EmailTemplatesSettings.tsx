...
const CATEGORY_BADGE: Record<EmailTemplate['category'], string> = {
  payments: 'bg-success/10 text-success border-success/30',
  hr: 'bg-primary/10 text-primary border-primary/30',
  ops: 'bg-primary/10 text-primary border-primary/30',
  compliance: 'bg-warning/10 text-warning border-warning/30',
  security: 'bg-destructive/10 text-destructive border-destructive/30',
  custom: 'bg-muted-foreground/10 text-muted-foreground border-muted-foreground/30',
};
