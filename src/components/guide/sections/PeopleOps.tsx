...
export function PeopleOpsSection() {
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      <Callout tone="tip">
        Training, Performance Reviews, Benefits, Surveys, Handbook, and Referrals are documented in the{' '}
        <strong>Growth & Wellbeing</strong> section of this guide. Placements is covered under{' '}
        <strong>CRM & Outreach</strong>. In the sidebar, find them under{' '}
        <strong>People & HR → Talent</strong> (Training, Performance),{' '}
        <strong>People & HR → Compensation & Wellbeing</strong> (Benefits),{' '}
        <strong>People & HR → Policy</strong> (Surveys, Handbook), and{' '}
        <strong>People & HR → Core HR</strong> (Placements).
      </Callout>
