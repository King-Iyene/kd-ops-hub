  ...
  return (
    <div className="space-y-6">
      ...
      <ModuleCard title="Clocking In & Attendance" route="/attendance" roles={['everyone']}>
        ...
        <Screenshot variant="contain" src="/guide/attendance-mobile.jpg" alt="The Attendance clock-in screen on a mobile phone" caption="Clock-in on mobile — the view most of the Field Team uses day to day." />
      </ModuleCard>
