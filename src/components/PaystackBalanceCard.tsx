...
const TONE: Record<Tone, {
  ...
  critical: {
    accentBar:  'bg-gradient-to-r from-destructive/40 via-destructive to-destructive/40',
    iconWrap:   'bg-destructive/10',
    icon:       'text-destructive',
    dot:        'bg-destructive',
    dotPulse:   'kd-status-live-danger',
    amount:     'text-destructive',
    banner:     'bg-destructive/10 border border-destructive/20',
    bannerText: 'text-destructive',
    caption:    'text-destructive/90',
  },
  unknown: {
    accentBar:  'bg-gradient-to-r from-muted-foreground/30 via-muted-foreground/40 to-muted-foreground/30',
    iconWrap:   'bg-muted',
            ...
            >
              <span
                className={cn(
                  ...
                  isActive
                    ? 'bg-white shadow-[0_0_6px_rgba(255,255,255,0.9)] kd-status-live-success'
