// Status utility functions and tone palette extracted from StatusBadge.tsx
...
export const STATUS_CONFIG: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  pending:                  { bg: 'bg-amber-50 border border-amber-200/80 dark:bg-amber-500/10 dark:border-amber-500/25',     text: 'text-warning',   dot: 'bg-amber-400',   label: 'Pending' },
  pending_approval:         { bg: 'bg-amber-50 border border-amber-200/80 dark:bg-amber-500/10 dark:border-amber-500/25',     text: 'text-warning',   dot: 'bg-amber-400',   label: 'Pending' },
  pending_second_approval:  { bg: 'bg-amber-50 border border-amber-200/80 dark:bg-amber-500/10 dark:border-amber-500/25',     text: 'text-warning',   dot: 'bg-amber-400',   label: '2nd Approval' },
  ...
  processed:                { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Completed' },
  succeeded:                { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Completed' },
  completed:                { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Completed' },
  paid:                     { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Paid' },
  active:                   { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Active' },
  ...
  failed:                   { bg: 'bg-red-50 border border-red-200/80 dark:bg-red-500/10 dark:border-red-500/25',             text: 'text-destructive',       dot: 'bg-red-400',     label: 'Failed' },
  rejected:                 { bg: 'bg-red-50 border border-red-200/80 dark:bg-red-500/10 dark:border-red-500/25',             text: 'text-destructive',       dot: 'bg-red-400',     label: 'Rejected' },
  cancelled:                { bg: 'bg-red-50 border border-red-200/80 dark:bg-red-500/10 dark:border-red-500/25',             text: 'text-destructive',       dot: 'bg-red-400',     label: 'Cancelled' },
  ...
  confirmed:                { bg: 'bg-emerald-50 border border-emerald-200/80 dark:bg-emerald-500/10 dark:border-emerald-500/25', text: 'text-success', dot: 'bg-emerald-400', label: 'Confirmed' },
  late:                     { bg: 'bg-red-50 border border-red-200/80 dark:bg-red-500/10 dark:border-red-500/25',               text: 'text-destructive',       dot: 'bg-red-400',     label: 'Late' },
...
export const FALLBACK = { bg: 'bg-slate-100 dark:bg-slate-500/10', text: 'text-slate-600 dark:text-slate-300', dot: 'bg-slate-400', label: '' };
