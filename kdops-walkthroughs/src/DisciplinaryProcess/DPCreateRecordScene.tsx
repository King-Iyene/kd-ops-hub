...
const ITEMS = [
  {
    "label": "Employee",
    "value": "Select the staff member",
    "icon": "👤"
  },
  {
    "label": "Category",
    "value": "Warning, Suspension, or Termination",
    "icon": "📋"
  },
  {
    "label": "Incident Date",
    "value": "When the incident occurred",
    "icon": "📅"
  },
  {
    "label": "Description",
    "value": "Detailed account of the issue",
    "icon": "📝"
  },
  {
    "label": "Evidence",
    "value": "Attach supporting documents",
    "icon": "📎"
  },
  {
    "label": "Witnesses",
    "value": "Name any witnesses",
    "icon": "👥"
  }
];

export const DPCreateRecordScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Disciplinary</span>
      </Interactive.Div>
      ...
      <Interactive.Div name="Title" style={{ fontSize: 36, fontWeight: 700, color: COLORS.white, marginBottom: 24, opacity: interpolate(frame, [0.1 * fps, 0.5 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        Creating a Disciplinary Record
      </Interactive.Div>
