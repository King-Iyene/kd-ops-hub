...
const ITEMS = [
  {
    "label": "Notification",
    "desc": "Employee receives alert to respond",
    "icon": "🔔"
  },
  {
    "label": "Response Window",
    "desc": "Set days allowed for reply",
    "icon": "⏰"
  },
  {
    "label": "Employee Reply",
    "desc": "Written response attached to record",
    "icon": "💬"
  },
  {
    "label": "HR Review",
    "desc": "Review response and update decision",
    "icon": "👁️"
  }
];

export const DPResponseThreadScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Response</span>
      </Interactive.Div>
