...
const ISSUES = [
  {
    icon: "⏰",
    problem: "Filing overdue?",
    solution: "File immediately — penalties may apply.",
    fallback: "Contact your tax consultant for penalty waiver options.",
  },
  {
    icon: "❌",
    problem: "Document rejected?",
    solution: "Check format requirements (PDF, max 5MB).",
    fallback: "Re-scan and re-upload the document.",
  },
  {
    icon: "💰",
    problem: "Wrong tax amount?",
    solution: "Verify employee tax tables are current.",
    fallback: "Recalculate using the latest PAYE bands.",
  },
  {
    icon: "📉",
    problem: "Compliance score low?",
    solution: "Address all overdue filing items first.",
    fallback: "Schedule a compliance review with your admin.",
  },
];

export const CCTroubleshootScene: React.FC = () => {
