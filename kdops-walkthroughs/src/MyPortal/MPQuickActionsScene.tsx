...
const ITEMS = [
  {
    ...
    "desc": "File a new expense claim",
    "icon": "🧾"
  },
  {
    "label": "Request Leave",
    "desc": "Apply for annual, sick, or compassionate leave",
    "icon": "📅"
  },
  {
    "label": "Fuel Request",
    "desc": "Log a fuel purchase for your assigned vehicle",
    "icon": "⛽"
  },
  {
    "label": "View Payslips",
    "desc": "Download your salary breakdown",
    "icon": "📄"
  }
];

export const MPQuickActionsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.accentBright }}>My Portal</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Quick Actions</span>
      </Interactive.Div>
