...
const ITEMS = [
  {
    "label": "Expense Claim",
    "value": "₦45,000 — Adaeze Okafor",
    "status": "Pending"
  },
  {
    "label": "Leave Request",
    "value": "5 days — Chidi Nwosu",
    "status": "Pending"
  },
  {
    "label": "Payment Batch",
    "value": "₦2.4M — Sep Payroll",
    "status": "Pending"
  },
  {
    "label": "EWA Request",
    "value": "₦80,000 — Fatima Bello",
    "status": "Pending"
  }
];

export const AIInboxViewScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.white }}>Approvals</span>
      </Interactive.Div>
