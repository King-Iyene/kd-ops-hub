...
const ITEMS = [
  {
    "label": "Approve",
    "desc": "Confirm and process",
    "icon": "✅"
  },
  {
    "label": "Reject",
    "desc": "Decline with reason",
    "icon": "❌"
  },
  {
    "label": "Request Info",
    "desc": "Ask for more details",
    "icon": "❓"
  }
];

export const AIApprovingItemScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.accentBright }}>Approvals</span><span style={{ margin: "0 8px" }}>{"›"}</span>
