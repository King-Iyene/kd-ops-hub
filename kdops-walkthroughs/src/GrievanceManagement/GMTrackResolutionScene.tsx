...
const ITEMS = [
  {
    "label": "Submitted",
    "desc": "Grievance received and logged",
    "icon": "📩",
    "color": "#8BAAB8"
  },
  {
    "label": "Under Review",
    "desc": "Grievance officer investigating",
    "icon": "🔍",
    "color": "#f59e0b"
  },
  {
    "label": "Action Taken",
    "desc": "Resolution steps implemented",
    "icon": "⚙️",
    "color": "#006994"
  },
  {
    "label": "Resolved",
    "desc": "Case closed with outcome",
    "icon": "✅",
    "color": "#22c55e"
  }
];

export const GMTrackResolutionScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Grievances</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Resolution</span>
      </Interactive.Div>
