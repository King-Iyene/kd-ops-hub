...
const ITEMS = [
  {
    "label": "Category",
    "value": "Harassment, Discrimination, Policy, Other",
    "icon": "📋"
  },
  {
    "label": "Description",
  ...
  {
    "label": "Evidence",
    "value": "Attach supporting files",
    "icon": "📎"
  },
  {
    "label": "Anonymous",
    "value": "Toggle to hide your identity",
    "icon": "🕶️"
  },
  {
    "label": "Priority",
...
export const GMFileGrievanceScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Grievances</span>
      </Interactive.Div>
