...
const ITEMS = [
  {
    "label": "Competency",
    "desc": "Skill or behaviour being evaluated",
    "icon": "📊"
  },
  {
    "label": "Rating Scale",
    "desc": "1-5 or custom scale",
    "icon": "⭐"
  },
  {
    "label": "Comments",
    "desc": "Specific feedback for each area",
    "icon": "💬"
  },
  {
    "label": "Goals Review",
    "desc": "Assess linked goal achievement",
    "icon": "🎯"
  },
  {
    "label": "Overall Rating",
    "desc": "Summary assessment",
    "icon": "📈"
  },
  {
    "label": "Development Areas",
    "desc": "Recommended improvements",
    "icon": "📚"
  }
];

export const PRRateCompetenciesScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Talent</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>Performance</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Review</span>
      </Interactive.Div>
