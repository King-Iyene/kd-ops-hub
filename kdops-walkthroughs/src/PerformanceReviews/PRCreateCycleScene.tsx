...
const ITEMS = [
  {
    "label": "Cycle Name",
    "value": "e.g. Q3 2026 Performance Review",
    "icon": "📋"
  },
  {
    "label": "Review Period",
  ...
  {
    "label": "Participants",
    "value": "Select departments or individuals",
    "icon": "👥"
  },
  {
    "label": "Competencies",
    "value": "Choose rating criteria",
    "icon": "📊"
  },
  {
    "label": "Reviewers",
    "value": "Assign managers as reviewers",
    "icon": "👤"
  },
  {
    "label": "Deadline",
    "value": "When all reviews must be completed",
    "icon": "⏰"
  }
];

export const PRCreateCycleScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Performance</span>
      </Interactive.Div>
