...
const ITEMS = [
  {
    ...
    "desc": "Review available to read",
    "icon": "🔔"
  },
  {
    "label": "Read Review",
    "desc": "Employee views all feedback",
    "icon": "📖"
  },
  {
    "label": "Employee Comments",
    "desc": "Optional response to feedback",
    "icon": "💬"
  },
  {
    "label": "Acknowledge",
    "desc": "Confirm review has been read",
    "icon": "✅"
  }
];

export const PRAcknowledgeReviewScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Acknowledge</span>
      </Interactive.Div>
