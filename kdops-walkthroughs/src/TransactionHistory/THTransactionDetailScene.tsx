...
const ITEMS = [
  {
    "label": "Initiated By",
    "value": "Who created the payment",
    "icon": "👤"
  },
  {
    "label": "Approved By",
    "value": "Who approved it",
    "icon": "✅"
  },
  {
    "label": "Payment Method",
    "value": "Bank transfer, card, etc.",
    "icon": "💳"
  },
  {
    "label": "Audit Trail",
...
export const THTransactionDetailScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Transactions</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Detail</span>
      </Interactive.Div>
