...
const ITEMS = [
  {
    "label": "Search",
    "value": "By reference, name, or amount",
    "icon": "🔍"
  },
  {
    "label": "Date Filter",
  ...
  {
    "label": "Type Filter",
    "value": "Payroll, Expense, Vendor, etc.",
    "icon": "📋"
  },
  {
    "label": "Status Filter",
...
export const THSearchTransactionsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Transactions</span>
      </Interactive.Div>
