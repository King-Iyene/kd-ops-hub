...
const ITEMS = [
  {
    ...
    "value": "₦180,000 earned this cycle",
    "icon": "💰"
  },
  {
    "label": "Request Amount",
    "value": "Enter up to your available balance",
    "icon": "🔢"
  },
  {
    "label": "Processing Fee",
    "value": "Small fee may apply",
    "icon": "📊"
  },
  {
    "label": "Net Amount",
    "value": "What you'll receive after fees",
    "icon": "✅"
  }
];

export const EWRequestEWAScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Earned Wages</span>
      </Interactive.Div>
