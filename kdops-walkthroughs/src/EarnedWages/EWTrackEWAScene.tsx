...
const ITEMS = [
  {
    "label": "Pending",
    "desc": "Waiting for finance approval",
    "icon": "⏳"
  },
  {
    "label": "Approved",
    "desc": "Payment being processed",
    "icon": "✅"
  },
  {
    "label": "Disbursed",
    "desc": "Sent to your bank account",
    "icon": "🏦"
  },
  {
    "label": "Deducted",
    "desc": "Taken from next payslip",
    "icon": "📄"
  }
];

export const EWTrackEWAScene: React.FC = () => {
