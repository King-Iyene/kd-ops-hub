...
export const LROutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You can now request leave, track balances, and approve requests for your
        team.
      </Interactive.Div>
      ...
      >
        {["Tasks & Accountability", "Payment Batches", "Payroll Intelligence"].map((title) => (
          <div
            key={title}
            style={{
