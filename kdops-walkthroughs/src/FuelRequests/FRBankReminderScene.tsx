...
const ITEMS = [
  {
    "label": "Bank Name",
    "value": "GTBank, Access, Zenith, etc.",
    "icon": "🏦"
  },
  {
    "label": "Account Number",
    "value": "10-digit NUBAN number",
    "icon": "🔢"
  },
  {
    "label": "Account Name",
    "value": "Must match your bank records",
    "icon": "👤"
  }
];

export const FRBankReminderScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.accentBright }}>Profile</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Bank Details</span>
      </Interactive.Div>
