...
const ITEMS = [
  ...
  {
    "label": "Fuel Type",
    "value": "PMS (Petrol) or AGO (Diesel)",
    "icon": "⛽"
  },
  {
    "label": "Amount",
  ...
  {
    "label": "Odometer",
    "value": "Check your dashboard reading",
    "icon": "🔢"
  },
  {
    "label": "Station",
    "value": "Where you bought fuel",
    "icon": "📍"
  },
  {
    "label": "Receipt",
    "value": "Take a photo and upload",
    "icon": "📸"
  }
];

export const FRSubmitRequestScene: React.FC = () => {
