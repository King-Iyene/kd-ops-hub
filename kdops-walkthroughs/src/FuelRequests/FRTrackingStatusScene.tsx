...
const ITEMS = [
  {
    "label": "Pending",
    "desc": "Waiting for manager review",
    "icon": "⏳",
    "color": "#f59e0b"
  },
  {
    "label": "Approved",
    "desc": "Accepted, processing payment",
    "icon": "✅",
    "color": "#22c55e"
  },
  {
    "label": "Rejected",
    "desc": "Declined — check comments",
    "icon": "❌",
    "color": "#ef4444"
  },
  {
    "label": "Disbursed",
    "desc": "Money sent to your bank",
    "icon": "🏦",
    "color": "#006994"
  }
];

export const FRTrackingStatusScene: React.FC = () => {
