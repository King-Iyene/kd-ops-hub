...
const ITEMS = [
  {
    "label": "Progress Bar",
    "desc": "Visual completion percentage",
    "icon": "📊",
    "color": "#22c55e"
  },
  {
    "label": "Key Result Updates",
    "desc": "Update each KR individually",
    "icon": "🔄",
    "color": "#006994"
  },
  {
    "label": "Check-ins",
    "desc": "Regular progress notes",
    "icon": "💬",
    "color": "#f59e0b"
  },
  {
    "label": "Status",
    "desc": "On Track, At Risk, Behind",
    "icon": "🚦",
    "color": "#00ECFF"
  }
];

export const GSTrackProgressScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.accentBright }}>Workspace</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>Productivity</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>Goals</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Progress</span>
      </Interactive.Div>
