...
const ITEMS = [
  {
    "label": "Goal Title",
    "value": "Clear, measurable objective",
    "icon": "🎯"
  },
  {
    "label": "Owner",
    "value": "Who is responsible",
    "icon": "👤"
  },
  {
    "label": "Time Period",
    "value": "Q1, Q2, Annual, Custom",
    "icon": "📅"
  },
  {
    "label": "Key Results",
    "value": "Measurable outcomes (up to 5)",
    "icon": "📊"
  },
  {
    "label": "Linked Tasks",
    "value": "Connect to existing tasks",
    "icon": "🔗"
  },
  {
    "label": "Visibility",
    "value": "Personal, Team, or Company-wide",
    "icon": "👁️"
  }
];

export const GSCreateGoalScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Goals</span>
      </Interactive.Div>
