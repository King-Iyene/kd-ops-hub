...
export const TAOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You can now create tasks, assign them to your team, and track progress on
        the board.
      </Interactive.Div>
      ...
      >
        {["Payment Batches", "Payroll Intelligence", "Document Vault"].map(
          (title) => (
            <div
              key={title}
              style={{
