...
const ITEMS = [
  {
    "label": "Active Plans",
    "desc": "Currently enrolled benefits",
    "icon": "✅",
    "color": "#22c55e"
  },
  {
    "label": "Pending",
    "desc": "Awaiting provider confirmation",
    "icon": "⏳",
    "color": "#f59e0b"
  },
  {
    "label": "Expiring Soon",
    "desc": "Benefits nearing renewal date",
    "icon": "⚠️",
    "color": "#ef4444"
  },
  {
    "label": "Total Cost",
    "desc": "Company benefit spend summary",
    "icon": "💰",
    "color": "#006994"
  }
];

export const BETrackEnrollmentsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Compensation</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>Benefits</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Dashboard</span>
      </Interactive.Div>
