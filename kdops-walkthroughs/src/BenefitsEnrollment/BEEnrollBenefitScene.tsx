...
const ITEMS = [
  ...
  {
    "label": "Benefit Type",
    "value": "HMO, Pension, Life Insurance, etc.",
    "icon": "📋"
  },
  {
    "label": "Plan",
    "value": "Choose the specific plan or tier",
    "icon": "📊"
  },
  {
    "label": "Coverage",
    "value": "Employee only, Employee + Family",
    "icon": "👨‍👩‍👧"
  },
  {
  ...
  {
    "label": "Provider",
    "value": "Insurance or pension provider",
    "icon": "🏢"
  }
];

export const BEEnrollBenefitScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Benefits</span>
      </Interactive.Div>
