...
export const BSOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You can now create budgets, track subscriptions, and stay on top of
      ...
      >
        {["Compliance Centre", "Fleet & Fuel", "Documents & Reports"].map((title) => (
          <div
            key={title}
            style={{
