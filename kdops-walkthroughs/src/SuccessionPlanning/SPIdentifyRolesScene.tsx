...
const ITEMS = [
  {
    "label": "Role Title",
    "value": "Name of the critical position",
    "icon": "👔"
  },
  {
    "label": "Current Holder",
    "value": "Who currently fills this role",
    "icon": "👤"
  },
  {
    "label": "Department",
    "value": "Which department the role belongs to",
    "icon": "🏢"
  },
  {
    "label": "Risk Level",
    "value": "Impact if role becomes vacant",
    "icon": "⚠️"
  },
  {
    "label": "Timeline",
    "value": "Expected transition window",
    "icon": "📅"
  }
];

export const SPIdentifyRolesScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Succession</span>
      </Interactive.Div>
