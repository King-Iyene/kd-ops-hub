...
const ITEMS = [
  {
    "label": "Pause",
    "desc": "Skip next payment",
    "icon": "⏸️"
  },
  {
    "label": "Edit",
    "desc": "Change amount or frequency",
    "icon": "✏️"
  },
  {
    "label": "Delete",
    "desc": "Stop schedule permanently",
    "icon": "🗑️"
  },
  {
    "label": "Draft Review",
    "desc": "Approve before disbursement",
    "icon": "👁️"
  }
];

export const PSCManageSchedulesScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Payment Schedule</span>
      </Interactive.Div>
