...
const ITEMS = [
  {
    ...
    "desc": "Upload and acknowledge",
    "icon": "📄"
  },
  {
    "label": "Knowledge Transfer",
    "desc": "Document handover tasks",
    "icon": "📚"
  },
  {
    "label": "Asset Return",
    "desc": "Collect laptop, ID card, keys",
    "icon": "🔑"
  },
  {
    "label": "Access Revocation",
    "desc": "Disable all system accounts",
    "icon": "🔒"
  },
  {
    "label": "Final Settlement",
    "desc": "Calculate remaining pay and deductions",
    "icon": "💰"
  },
  {
    "label": "Exit Interview",
    "desc": "Schedule feedback session",
    "icon": "🗣️"
  }
];

export const OOExitChecklistScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Offboarding</span>
      </Interactive.Div>
