...
const ITEMS = [
  {
    "label": "Welcome Email",
    "desc": "Send login credentials and handbook",
    "icon": "📧"
  },
  {
    "label": "IT Setup",
    "desc": "Laptop, email account, software access",
    "icon": "💻"
  },
  {
    "label": "Bank Details",
    "desc": "Collect for payroll setup",
    "icon": "🏦"
  },
  {
    "label": "ID Card",
    "desc": "Issue employee identification",
    "icon": "🪪"
  },
  {
    "label": "Orientation",
    "desc": "Schedule team introduction meeting",
    "icon": "🤝"
  },
  {
    "label": "Policy Sign-off",
    "desc": "Acknowledge company policies",
    "icon": "📝"
  }
];

export const OOJoiningChecklistScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Onboarding</span>
      </Interactive.Div>
