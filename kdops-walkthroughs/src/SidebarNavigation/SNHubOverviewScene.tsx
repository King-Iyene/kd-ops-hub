...
const ITEMS = [
  {
    "label": "Finance",
    "desc": "Payments, payroll & treasury",
    "icon": "🏦",
    "color": "#22c55e"
  },
  {
    "label": "People & HR",
    "desc": "Staff, leave & compliance",
    "icon": "👥",
    "color": "#3b82f6"
  },
  {
    "label": "Operations",
    "desc": "Fleet & vendor management",
    "icon": "🚛",
    "color": "#f59e0b"
  },
  {
    "label": "Workspace",
    "desc": "Tasks, docs & reports",
    "icon": "📋",
    "color": "#8b5cf6"
  },
  {
    "label": "CRM",
    "desc": "Clients, contacts & outreach",
    "icon": "🤝",
    "color": "#0ea5e9"
  },
  {
    "label": "Admin",
    "desc": "Settings & audit controls",
    "icon": "⚙️",
    "color": "#94a3b8"
  }
];

export const SNHubOverviewScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.white }}>Sidebar</span>
      </Interactive.Div>
