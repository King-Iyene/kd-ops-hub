...
const ITEMS = [
  {
    "label": "Payments",
    "desc": "Finance → Money Out → Payments",
    "icon": "💳"
  },
  {
    "label": "Employees",
    "desc": "People & HR → Core HR → Employees",
    "icon": "👤"
  },
  {
    "label": "Fleet",
    "desc": "Operations → Fleet",
    "icon": "🚛"
  },
  {
    "label": "Tasks",
    "desc": "Workspace → Productivity → Tasks",
    "icon": "✅"
  },
  {
    "label": "Compliance",
    "desc": "Finance → Risk & Controls → Compliance",
    "icon": "🛡️"
  },
  {
    "label": "Reports",
    "desc": "Workspace → Intelligence → Reports",
    "icon": "📊"
  }
];

export const SNFindingModulesScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        <span style={{ color: COLORS.accentBright }}>Sidebar</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Search</span>
      </Interactive.Div>
