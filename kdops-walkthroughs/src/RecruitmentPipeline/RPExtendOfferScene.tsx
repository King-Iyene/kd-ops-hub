...
const ITEMS = [
  {
    "label": "Candidate",
    "value": "Select from Offer stage",
    "icon": "👤"
  },
  {
    "label": "Position",
    "value": "Auto-filled from opening",
    "icon": "📋"
  },
  {
    "label": "Salary",
    "value": "Enter the offered compensation",
    "icon": "💰"
  },
  {
    "label": "Start Date",
    "value": "Proposed joining date",
    "icon": "📅"
  },
  {
    "label": "Offer Letter",
    "value": "Generate or upload PDF",
    "icon": "📄"
  },
  {
    "label": "Send Offer",
    "value": "Email to candidate",
    "icon": "📧"
  }
];

export const RPExtendOfferScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Offer</span>
      </Interactive.Div>
