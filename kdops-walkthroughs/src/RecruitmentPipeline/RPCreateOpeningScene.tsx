...
const ITEMS = [
  {
    "label": "Job Title",
    "value": "Enter the position name",
    "icon": "📝"
  },
  {
    "label": "Department",
    "value": "Select the hiring department",
    "icon": "🏢"
  },
  {
  ...
  {
    "label": "Salary Range",
    "value": "Set min and max compensation",
    "icon": "💰"
  },
  {
    "label": "Requirements",
    "value": "List qualifications and skills",
    "icon": "✅"
  },
  {
    "label": "Posting Status",
    "value": "Draft, Published, or Closed",
    "icon": "📢"
  }
];

export const RPCreateOpeningScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Recruitment</span>
      </Interactive.Div>
