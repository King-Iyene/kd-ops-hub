...
const ITEMS = [
  {
    "label": "Applied",
    "desc": "New applications received",
    "icon": "📩",
    "color": "#8BAAB8"
  },
  {
    "label": "Screening",
    "desc": "Resume review in progress",
    "icon": "🔍",
    "color": "#f59e0b"
  },
  {
    "label": "Interview",
    "desc": "Scheduled for interview",
    "icon": "🗓️",
    "color": "#006994"
  },
  {
    "label": "Offer",
    "desc": "Ready for offer letter",
    "icon": "📄",
    "color": "#22c55e"
  },
  {
    "label": "Hired",
    "desc": "Offer accepted, onboarding next",
    "icon": "✅",
    "color": "#00ECFF"
  },
  {
    "label": "Rejected",
    "desc": "Did not proceed",
    "icon": "❌",
    "color": "#ef4444"
  }
];

export const RPManageCandidatesScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Recruitment</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Pipeline</span>
      </Interactive.Div>
