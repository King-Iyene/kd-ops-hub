...
const ITEMS = [
  {
    ...
    "desc": "Email link to employee",
    "icon": "📧"
  },
  {
    "label": "Employee Signs",
    "desc": "Digital signature on the letter",
    "icon": "✍️"
  },
  {
    "label": "Countersign",
    "desc": "HR or manager signs after employee",
    "icon": "👤"
  },
  {
    "label": "Signed Copy",
    "desc": "Download the completed letter",
    "icon": "📥"
  }
];

export const HLESignatureScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Documents</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>HR Letters</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Signature</span>
      </Interactive.Div>
