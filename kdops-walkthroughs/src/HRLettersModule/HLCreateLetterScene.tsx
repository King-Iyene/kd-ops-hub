...
const ITEMS = [
  {
    "label": "Template",
    "value": "Select from available letter types",
    "icon": "📄"
  },
  {
    "label": "Employee",
    "value": "Choose the recipient",
    "icon": "👤"
  },
  {
    "label": "Effective Date",
    "value": "When the letter takes effect",
    "icon": "📅"
  },
  {
    "label": "Custom Fields",
    "value": "Fill in template variables",
    "icon": "✏️"
  },
  {
    "label": "Preview",
...
export const HLCreateLetterScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>HR Letters</span>
      </Interactive.Div>
