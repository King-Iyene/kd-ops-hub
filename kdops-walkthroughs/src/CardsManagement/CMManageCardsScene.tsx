...
const ITEMS = [
  {
    "label": "Cardholder",
    "value": "Who the card is assigned to",
    "icon": "👤"
  },
  {
    "label": "Limit",
    "value": "Maximum spending amount",
    "icon": "💰"
  },
  {
    "label": "Spent",
    "value": "Amount used so far",
    "icon": "📊"
  },
  {
    "label": "Status",
    "value": "Active, Frozen, or Expired",
    "icon": "🔒"
  }
];

export const CMManageCardsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Cards</span>
      </Interactive.Div>
