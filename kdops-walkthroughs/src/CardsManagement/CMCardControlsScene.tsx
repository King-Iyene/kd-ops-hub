...
const ITEMS = [
  {
    ...
    "desc": "Max amount per purchase",
    "icon": "🔢"
  },
  {
    "label": "Merchant restrictions",
    "desc": "Limit to certain categories",
    "icon": "🏪"
  },
  {
    "label": "Real-time monitoring",
    "desc": "See every charge instantly",
    "icon": "👁️"
  },
  {
    "label": "Instant freeze",
    "desc": "Disable with one click",
    "icon": "🧊"
  }
];

export const CMCardControlsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Cards</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Controls</span>
      </Interactive.Div>
