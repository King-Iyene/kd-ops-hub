...
const ITEMS = [
  {
    "label": "Run Payroll",
    "desc": "Start the payroll process",
    "icon": "▶️"
  },
  {
    "label": "Review EWA",
    "desc": "Approve wage advances",
    "icon": "💸"
  },
  {
    "label": "Staff Loans",
  ...
  {
    "label": "Compliance",
    "desc": "Statutory deductions",
    "icon": "🏛️"
  }
];

export const PHPayNavigationScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Pay Hub</span>
      </Interactive.Div>
