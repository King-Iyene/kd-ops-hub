...
export const DRAIntroScene: React.FC = () => {
    ...
    >
      ...
      <Interactive.Div
        ...
        style={{
          ...
          alignItems: "center",
          marginBottom: 32,
          scale: interpolate(frame, [0.2 * fps, 0.7 * fps], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
      ...
      >
        Generate reports, manage documents, and configure settings
      </Interactive.Div>
