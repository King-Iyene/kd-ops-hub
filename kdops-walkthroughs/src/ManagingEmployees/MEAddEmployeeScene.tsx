...
const FORM_FIELDS = [
  { label: "Full Name", value: "Adaeze Okonkwo", filled: true },
  { label: "Email Address", value: "adaeze@kdsquares.com", filled: true },
  { label: "Phone Number", value: "+234 801 234 5678", filled: true },
  { label: "Role", value: "Operations", filled: true },
  { label: "Department", value: "KD Squares", filled: true },
  { label: "Start Date", value: "15 Sept 2026", filled: true },
];

const STEPS = [
  { num: "1", title: "Click \"+ Add Employee\"", desc: "Top-right corner of the Employees page" },
  { num: "2", title: "Fill in basic details", desc: "Name, email, phone, role, and department" },
  { num: "3", title: "Set role & permissions", desc: "Choose what modules they can access" },
  { num: "4", title: "Send invite", desc: "They'll receive an email to set up their password" },
];
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
        ...
        >
          ...
          >
            {frame > 5 * fps ? "✓ Invite Sent!" : "Send Invite →"}
          </div>
        </Interactive.Div>
      </div>
    </AbsoluteFill>
