...
export const MEIntroScene: React.FC = () => {
    ...
    >
      ...
      <Interactive.Div
        ...
        style={{
          ...
          alignItems: "center",
          marginBottom: 32,
          scale: interpolate(frame, [0.2 * fps, 0.7 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.spring({ damping: 200 }) }),
        }}
      >
      ...
      >
        Add, manage, and organise your team in People & HR
      </Interactive.Div>
