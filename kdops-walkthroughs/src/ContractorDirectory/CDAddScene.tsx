...
const FORM_FIELDS = [
  { label: "Full Name", value: "Chidi Amaechi" },
  { label: "Company", value: "TechServe Nigeria" },
...
const STEPS = [
  ...
  { num: "2", title: "Fill in contractor details", desc: "Name, company, and contact information" },
  { num: "3", title: "Set contract terms & rate", desc: "Contract type, duration, and payment rate" },
  { num: "4", title: "Activate contract", desc: "The contractor appears in your directory immediately" },
];

export const CDAddScene: React.FC = () => {
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
        ...
        >
          ...
          >
            {frame > 5 * fps ? "✓ Contract Activated!" : "Activate Contract →"}
          </div>
        </Interactive.Div>
      </div>
    </AbsoluteFill>
