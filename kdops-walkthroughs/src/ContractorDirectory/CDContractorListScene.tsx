...
const CONTRACTORS = [
  { initials: "JA", name: "James Adeyemi", company: "Adeyemi Consulting", type: "Fixed-Term", rate: "₦450,000/mo", status: "Active", color: "#22c55e" },
  { initials: "FO", name: "Funke Okafor", company: "Okafor Legal", type: "Retainer", rate: "₦200,000/mo", status: "Active", color: "#3b82f6" },
  { initials: "TE", name: "Tunde Eze", company: "EzeTech Solutions", type: "Project", rate: "₦85,000/day", status: "Active", color: "#f59e0b" },
  { initials: "NB", name: "Ngozi Bassey", company: "Bassey HR Consult", type: "Fixed-Term", rate: "₦350,000/mo", status: "Expiring", color: "#ef4444" },
  { initials: "AW", name: "Ade Williams", company: "Williams & Co", type: "Retainer", rate: "₦180,000/mo", status: "Active", color: "#8b5cf6" },
];
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: 16, color: COLORS.textMuted }}>3 contract types</span>
        </div>
      </Interactive.Div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <span style={{
                  ...
                  background: c.status === "Active" ? `${COLORS.green}22` : `${COLORS.orange}22`,
                  padding: "4px 10px",
                  borderRadius: 6,
                }}>
                  {c.status}
