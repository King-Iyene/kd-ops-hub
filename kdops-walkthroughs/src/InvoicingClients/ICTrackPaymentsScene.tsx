...
const ITEMS = [
  {
    "label": "Draft",
    "desc": "Not yet sent to client",
    "icon": "📝",
    "color": "#8BAAB8"
  },
  {
    "label": "Sent",
    "desc": "Invoice delivered, awaiting payment",
    "icon": "📧",
    "color": "#f59e0b"
  },
  {
    "label": "Paid",
    "desc": "Payment received in full",
    "icon": "✅",
    "color": "#22c55e"
  },
  {
    "label": "Overdue",
    "desc": "Past due date, follow up needed",
    "icon": "🔴",
    "color": "#ef4444"
  },
  {
...
export const ICTrackPaymentsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Invoices</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Payments</span>
      </Interactive.Div>
