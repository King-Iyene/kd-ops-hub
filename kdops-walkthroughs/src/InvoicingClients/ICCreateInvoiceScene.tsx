...
const ITEMS = [
  {
    "label": "Client",
    "value": "Select from your client directory",
    "icon": "🤝"
  },
  {
  ...
  {
    "label": "Line Items",
    "value": "Add services, products, or fees",
    "icon": "📋"
  },
  {
    "label": "VAT",
    "value": "Apply VAT rate (7.5% default)",
    "icon": "📊"
  },
  {
    "label": "Discount",
    "value": "Optional percentage or flat discount",
    "icon": "💸"
  },
  {
    "label": "Due Date",
...
export const ICCreateInvoiceScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Invoices</span>
      </Interactive.Div>
