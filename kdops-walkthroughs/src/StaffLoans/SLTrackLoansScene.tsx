...
const ITEMS = [
  {
    "label": "Active Loans",
    "desc": "Currently being repaid",
    "icon": "📊"
  },
  {
    "label": "Repayment History",
    "desc": "Every deduction logged",
    "icon": "📝"
  },
  {
    "label": "Adjust Loan",
    "desc": "Extend, pause, or write off",
    "icon": "✏️"
  },
  {
    "label": "Final Settlement",
    "desc": "Handled at offboarding",
    "icon": "🏁"
  }
];

export const SLTrackLoansScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Staff Loans</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Repayments</span>
      </Interactive.Div>
