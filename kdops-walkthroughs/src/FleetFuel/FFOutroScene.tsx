...
export const FFOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You can now manage vehicles, track fuel spend, and monitor vendor contracts.
      </Interactive.Div>
      ...
      >
        {["Documents & Reports", "Admin Settings", "Welcome to KDOps"].map((title) => (
          <div
            key={title}
            style={{
