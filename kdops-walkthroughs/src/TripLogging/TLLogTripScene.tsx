...
const ITEMS = [
  {
    "label": "Vehicle",
    "value": "Select your assigned vehicle",
    "icon": "🚗"
  },
  {
    "label": "Start Location",
    "value": "Where you departed from",
    "icon": "📍"
  },
  {
    "label": "Destination",
    "value": "Where you went",
    "icon": "🏁"
  },
  {
    "label": "Start Odometer",
    "value": "Reading before trip",
    "icon": "🔢"
  },
  {
    "label": "End Odometer",
    "value": "Reading after trip",
    "icon": "🔢"
  },
  {
    "label": "Purpose",
    "value": "Client Visit, Delivery, etc.",
    "icon": "📋"
  }
];

export const TLLogTripScene: React.FC = () => {
