...
export const EAOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You now know how to file expenses, attach receipts, track approval
        status, and manage the full reimbursement cycle end-to-end.
      </Interactive.Div>
      ...
      >
        {["Payroll Intelligence", "Budgets & Subscriptions", "Compliance Centre"].map((title) => (
          <div
            key={title}
            style={{
