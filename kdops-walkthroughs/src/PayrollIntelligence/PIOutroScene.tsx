...
export const PIOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        You can now run payroll, understand deductions, track history, and troubleshoot issues with confidence.
      </Interactive.Div>
      ...
      >
        {["Budgets & Subscriptions", "Compliance Centre", "Fleet & Fuel"].map((title) => (
          <div
            key={title}
            style={{
