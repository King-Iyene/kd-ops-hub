...
const ITEMS = [
  {
    "label": "Notification",
    "desc": "Receive survey link via email or in-app",
    "icon": "🔔"
  },
  {
    "label": "Answer Questions",
    "desc": "Complete all required fields",
    "icon": "✏️"
  },
  {
    "label": "Submit",
    "desc": "Send your responses",
    "icon": "📤"
  },
  {
    "label": "Confirmation",
    "desc": "Receive submission confirmation",
    "icon": "✅"
  }
];

export const SVRespondToSurveyScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Respond</span>
      </Interactive.Div>
