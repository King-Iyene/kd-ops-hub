...
const ITEMS = [
  {
    "label": "Survey Title",
    "value": "Name your survey clearly",
    "icon": "📝"
  },
  {
    "label": "Questions",
    "value": "Add multiple choice, rating, or text",
    "icon": "❓"
  },
  {
    "label": "Target Audience",
    "value": "All employees, department, or role",
    "icon": "👥"
  },
  {
    "label": "Anonymous",
    "value": "Toggle for anonymous responses",
    "icon": "🕶️"
  },
  {
    "label": "Deadline",
    "value": "When responses are due",
    "icon": "📅"
  },
  {
    "label": "Publish",
    "value": "Send to participants",
    "icon": "📤"
  }
];

export const SVCreateSurveyScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.white }}>Surveys</span>
      </Interactive.Div>
