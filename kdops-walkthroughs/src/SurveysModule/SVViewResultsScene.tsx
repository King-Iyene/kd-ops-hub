...
const ITEMS = [
  {
    "label": "Response Rate",
    "desc": "Percentage of participants who responded",
    "icon": "📊"
  },
  {
    "label": "Summary Charts",
    "desc": "Visual breakdown of each question",
    "icon": "📈"
  },
  {
    "label": "Individual Responses",
    "desc": "Read text answers (anonymous if set)",
    "icon": "📝"
  },
  {
    "label": "Export",
    "desc": "Download results as CSV or PDF",
    "icon": "📥"
  }
];

export const SVViewResultsScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily, padding: "40px 60px" }}>
      ...
      <Interactive.Div name="Breadcrumb" style={{ fontSize: 14, fontFamily: monoFamily, color: COLORS.textMuted, marginBottom: 10, opacity: interpolate(frame, [0, 0.3 * fps], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
        ...
        <span style={{ color: COLORS.accentBright }}>Engagement</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.accentBright }}>Surveys</span><span style={{ margin: "0 8px" }}>{"›"}</span>
        <span style={{ color: COLORS.white }}>Results</span>
      </Interactive.Div>
