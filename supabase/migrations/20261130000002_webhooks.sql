...
CREATE INDEX idx_webhooks_base ON nc_meta.webhooks (base_id) WHERE is_active = true;
CREATE INDEX idx_webhooks_table ON nc_meta.webhooks (table_id) WHERE is_active = true;
