...
DROP POLICY IF EXISTS "contractors_select_scoped" ON public.contractors;
...
DROP POLICY IF EXISTS "budget_items_write_admin" ON public.budget_items;
...
DROP POLICY IF EXISTS "cfd_write_admin" ON public.custom_field_definitions;
CREATE POLICY "cfd_write_admin"
  ON public.custom_field_definitions FOR INSERT TO authenticated
  WITH CHECK (public.current_user_role() IN ('super_admin','admin'));

DROP POLICY IF EXISTS "cfd_update_admin" ON public.custom_field_definitions;
CREATE POLICY "cfd_update_admin"
  ON public.custom_field_definitions FOR UPDATE TO authenticated
  USING  (public.current_user_role() IN ('super_admin','admin'))
  WITH CHECK (public.current_user_role() IN ('super_admin','admin'));

DROP POLICY IF EXISTS "cfd_delete_admin" ON public.custom_field_definitions;
...
DROP POLICY IF EXISTS "cfv_write_admin" ON public.custom_field_values;
...
DROP POLICY IF EXISTS "cfv_update_admin" ON public.custom_field_values;
CREATE POLICY "cfv_update_admin"
  ON public.custom_field_values FOR UPDATE TO authenticated
  USING  (public.current_user_role() IN ('super_admin','admin','operations'))
  WITH CHECK (public.current_user_role() IN ('super_admin','admin','operations'));

DROP POLICY IF EXISTS "cfv_delete_admin" ON public.custom_field_values;
...
DROP POLICY IF EXISTS "fuel_requests_select_all" ON public.fuel_requests;
CREATE POLICY "fuel_requests_select_all"
  ON public.fuel_requests FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "fuel_requests_insert" ON public.fuel_requests;
CREATE POLICY "fuel_requests_insert"
  ON public.fuel_requests FOR INSERT TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "fuel_requests_update" ON public.fuel_requests;
...
DROP POLICY IF EXISTS "fuel_requests_delete" ON public.fuel_requests;
...
DROP POLICY IF EXISTS "trip_logs_insert" ON public.trip_logs;
CREATE POLICY "trip_logs_insert"
  ON public.trip_logs FOR INSERT TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "trip_logs_update" ON public.trip_logs;
...
DROP POLICY IF EXISTS "trip_logs_delete" ON public.trip_logs;
...
DROP POLICY IF EXISTS "vehicle_inspections_update_scoped" ON public.vehicle_inspections;
...
DROP POLICY IF EXISTS "knowledge_versions_select" ON public.knowledge_article_versions;
CREATE POLICY "knowledge_versions_select"
  ON public.knowledge_article_versions FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "knowledge_versions_write" ON public.knowledge_article_versions;
CREATE POLICY "knowledge_versions_write"
  ON public.knowledge_article_versions FOR INSERT TO authenticated
  WITH CHECK (public.current_user_role() IN ('super_admin','admin'));

DROP POLICY IF EXISTS "knowledge_versions_update" ON public.knowledge_article_versions;
CREATE POLICY "knowledge_versions_update"
  ON public.knowledge_article_versions FOR UPDATE TO authenticated
  USING  (public.current_user_role() IN ('super_admin','admin'))
  WITH CHECK (public.current_user_role() IN ('super_admin','admin'));

DROP POLICY IF EXISTS "knowledge_versions_delete" ON public.knowledge_article_versions;
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "space_folders_read_write" ON public.space_folders;
  CREATE POLICY "space_folders_read_write" ON public.space_folders
    FOR SELECT TO authenticated USING (true);
  DROP POLICY IF EXISTS "space_folders_insert" ON public.space_folders;
  CREATE POLICY "space_folders_insert" ON public.space_folders
    FOR INSERT TO authenticated WITH CHECK (true);
  DROP POLICY IF EXISTS "space_folders_update" ON public.space_folders;
  CREATE POLICY "space_folders_update" ON public.space_folders
    FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
  DROP POLICY IF EXISTS "space_folders_delete" ON public.space_folders;
  ...
  DROP POLICY IF EXISTS "space_members_read_write" ON public.space_members;
  ...
  DROP POLICY IF EXISTS "space_statuses_read_write" ON public.space_statuses;
  CREATE POLICY "space_statuses_read_write" ON public.space_statuses
    FOR SELECT TO authenticated USING (true);
  DROP POLICY IF EXISTS "space_statuses_insert" ON public.space_statuses;
  CREATE POLICY "space_statuses_insert" ON public.space_statuses
    FOR INSERT TO authenticated WITH CHECK (true);
  DROP POLICY IF EXISTS "space_statuses_update" ON public.space_statuses;
  CREATE POLICY "space_statuses_update" ON public.space_statuses
    FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
  DROP POLICY IF EXISTS "space_statuses_delete" ON public.space_statuses;
  ...
  CREATE POLICY "task_time_entries_update" ON public.task_time_entries
    FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
  DROP POLICY IF EXISTS "task_time_entries_delete" ON public.task_time_entries;
  ...
  DROP POLICY IF EXISTS "task_forms_select" ON public.task_forms;
  CREATE POLICY "task_forms_select" ON public.task_forms
    FOR SELECT TO authenticated USING (true);
  DROP POLICY IF EXISTS "task_forms_insert" ON public.task_forms;
  CREATE POLICY "task_forms_insert" ON public.task_forms
    FOR INSERT TO authenticated WITH CHECK (true);
  DROP POLICY IF EXISTS "task_forms_update" ON public.task_forms;
  CREATE POLICY "task_forms_update" ON public.task_forms
    FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
  DROP POLICY IF EXISTS "task_forms_delete" ON public.task_forms;
  ...
  DROP POLICY IF EXISTS "goal_tasks_select" ON public.goal_tasks;
  CREATE POLICY "goal_tasks_select" ON public.goal_tasks
    FOR SELECT TO authenticated USING (true);
  DROP POLICY IF EXISTS "goal_tasks_insert" ON public.goal_tasks;
  CREATE POLICY "goal_tasks_insert" ON public.goal_tasks
    FOR INSERT TO authenticated WITH CHECK (true);
  DROP POLICY IF EXISTS "goal_tasks_update" ON public.goal_tasks;
  CREATE POLICY "goal_tasks_update" ON public.goal_tasks
    FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
  DROP POLICY IF EXISTS "goal_tasks_delete" ON public.goal_tasks;
